...
class RaceSnapshot {
  ...
  /// A polár-alapú target VMG (kn) a tick pillanatában, vagy `null`, ha
  /// nincs polár, hiányzik a water-referenciájú szél, vagy a sávban nincs
  /// adat (ADR 0028 Addendum 4). Előjeles, az élő VMG-vel összevethető;
